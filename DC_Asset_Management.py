...
class ITAssetManagerGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("IT Asset Manager (Docker + PostgreSQL)")
        ...
        try:
            ...
            messagebox.showerror("데이터베이스 오류", f"데이터베이스 연결에 실패했습니다:\n{str(e)}")
